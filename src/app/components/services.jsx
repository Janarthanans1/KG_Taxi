  ...
  return (
    <div>
        ...
        <div className='flex flex-col gap-16 md:flex-row md:gap-2 lg:gap-10 justify-evenly items-center pt-20 '>
            {/*service 1*/}
            <div className="relative w-72 sm:w-3/4 h-fit bg-white border-2 border-blue-950 rounded-lg shadow-lg p-6">
                <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 w-20 h-20 bg-blue-500 text-white text-5xl rounded-full flex justify-center items-center shadow-xl">
                  <RiTaxiFill />
                </div>
                <div className="mt-12 text-center">
                  <h2 className="text-xl font-semibold text-blue-950 mb-2">Local Rides</h2>
            ...
            {/*service 2*/}
            <div className='relative w-72 sm:w-3/4 h-fit bg-white border-2 border-blue-950 rounded-lg shadow-lg p-6'>
                <div className='absolute -top-8 left-1/2 transform -translate-x-1/2 w-20 h-20 bg-blue-500 text-white text-5xl rounded-full flex justify-center items-center shadow-xl'><RiRoadMapFill/></div>
                <div className="mt-12 text-center">
                  <h2 className="text-xl font-semibold text-blue-950 mb-2">Outstation Rides</h2>
                  <p className="text-gray-700 text-sm text-justify">
            ...
            {/*service 3*/}
            <div className='relative w-72 sm:w-3/4 h-fit bg-white border-2 border-blue-950 rounded-lg shadow-lg p-6'>
                <div className='absolute -top-8 left-1/2 transform -translate-x-1/2 w-20 h-20 bg-blue-500 text-white text-5xl rounded-full flex justify-center items-center shadow-xl'><RiCarFill/></div>
                <div className="mt-12 text-center">
                  <h2 className="text-xl font-semibold text-blue-950 mb-2">Rental Rides</h2>
                  <p className="text-gray-700 text-sm text-justify">
